...
<ul className="nav">
  ...
  {/* <li className="nav-item">
   ...
   <li className="nav-item">
    <a className="nav-link" href="/order">
      ...
      <span className="menu-title">Đơn đặt hàng</span>
    </a>
  </li>
  <li className="nav-item">
    ...
    <div className="collapse" id="ui-basic">
      <ul className="nav flex-column sub-menu">
        <li className="nav-item"> <a className="nav-link" href="/warehouse">Danh sách sản phẩm  kho</a></li>
        <li className="nav-item"><a className="nav-link" href="/addwarehouse">Nhập kho</a></li>
      </ul>
    </div>
  </li>
  <li className="nav-item">
  ...
  <li className="nav-item nav-category">Dữ liệu</li>
  <li className="nav-item">
    ...
    <div className="collapse" id="form-elements">
      <ul className="nav flex-column sub-menu">
        <li className="nav-item"><a className="nav-link" href="/product">Danh sách sản phẩm</a></li>
        <li className="nav-item"><a className="nav-link" href="/addProduct">Thêm sản phẩm</a></li>
      </ul>
  ...
  <li className="nav-item">
    <a className="nav-link" data-bs-toggle="collapse" href="#charts" aria-expanded="false" aria-controls="charts">
      ...
      <span className="menu-title">Thương hiệu</span>
      <i className="menu-arrow"></i>
    </a>
    <div className="collapse" id="charts">
      <ul className="nav flex-column sub-menu">
        <li className="nav-item"> <a className="nav-link" href="/brand">Danh sách thương hiệu</a></li>
        <li className="nav-item"> <a className="nav-link" href="/addbrand">Thêm thương hiệu</a></li>
      </ul>
    </div>
  </li>
  <li className="nav-item">
    ...
    <div className="collapse" id="tables">
      <ul className="nav flex-column sub-menu">
        <li className="nav-item"> <a className="nav-link" href="/categories">Danh sách thể loại</a></li>
        <li className="nav-item"> <a className="nav-link" href="addcategories">Thêm thể loại</a></li>
      </ul>
    </div>
  </li>
  <li className="nav-item">
    ...
    <div className="collapse" id="icons">
      <ul className="nav flex-column sub-menu">
        <li className="nav-item"> <a className="nav-link" href="/discount">Danh sách mã</a></li>
        <li className="nav-item"> <a className="nav-link" href="adddiscount">Thêm mã</a></li>
      </ul>
    </div>
  </li>
  <li className="nav-item">
    <a className="nav-link" data-bs-toggle="collapse" href="#icons" aria-expanded="false" aria-controls="icons">
      ...
      <span className="menu-title">Loại Hình</span>
      <i className="menu-arrow"></i>
    </a>
    <div className="collapse" id="icons">
      <ul className="nav flex-column sub-menu">
        <li className="nav-item"> <a className="nav-link" href="type">Danh sách</a></li>
        <li className="nav-item"> <a className="nav-link" href="addtype">Thêm</a></li>
      </ul>
    </div>
  </li>
  <li className="nav-item">
    ...
    <div className="collapse" id="icons">
      <ul className="nav flex-column sub-menu">
        <li className="nav-item"> <a className="nav-link" href="size">Danh sách Size</a></li>
        <li className="nav-item"> <a className="nav-link" href="addsize">Thêm Size</a></li>
      </ul>
    </div>
  </li>
